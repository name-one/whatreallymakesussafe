export const GAME_CHANGERS_SECTION = [
  {
    ...
    nav: 'Bios',
    question: 'The following activist-thinkers engaged in community accountability & transformative justice work were interviewed for the "What would really make us safe?" project. '
    ...
    + '<br><br>' +'Most interviews were carried out by Melanie, and several were conducted by comrades from the Transformative Justice Kollektiv Berlin.',
    quotes: [
      {
      ...
      {
        tagline: 'Qui Alexander & Jenna Peters-Golden of Philly Stands Up Collective',
  ...
  },
  {
    ...
    + '<br><br>' + '& internationally… <a href="http://www.bridgesinstitute.org/">Bridges Institutet</a>'
